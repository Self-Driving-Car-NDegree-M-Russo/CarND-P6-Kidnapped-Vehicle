...
For it the goal is to write C++ code implementing a Particle Filter to localize a moving object of interest, starting from a feature map and noisy measurements.
