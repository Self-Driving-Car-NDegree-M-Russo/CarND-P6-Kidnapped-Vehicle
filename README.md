...
The source code for this project, is submitted as part of this Git repo (in the [src](/src) folder). A detailed explanation is provided in a separate [writeup](Kidnapped_vehcile_writeup.md), that documents also the results of the filter.  
